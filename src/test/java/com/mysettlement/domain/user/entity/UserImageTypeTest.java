...
class UserImageTypeTest {
	...
	void testGetImagePathOf_Profile() {
		String profilePath = UserImageType.PROFILE.getImagePathOf(mockUser);
	...
	void testGetImagePathOf_Background() {
		String backgroundPath = UserImageType.BACKGROUND.getImagePathOf(mockUser);
